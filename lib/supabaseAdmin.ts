...
const upsertProductRecord = async (product: Stripe.Product) => {
  console.log('upsertProductRecord product', product)
  ...
  if (upsertProductError) {
    console.log('Error upserting product', upsertProductError)
...
const upsertPriceRecord = async (price: Stripe.Price) => {
  console.log('upsertPriceRecord price', price)
...
const copyBillingDetailsToCustomer = async (
  ...
  console.log('copyBillingDetailsToCustomer payment_method', payment_method)
  ...
  const { error } = await supabaseAdmin
    ...
    .eq('id', uuid)
  if (error) {
    console.log('Error updating user billing details', error)
    throw error
  }
}
...
const manageSubscriptionStatusChange = async (
  ...
  const { data: customerData, error: noCustomerError } = await supabaseAdmin
    ...
    .single()
  if (noCustomerError) {
    console.log('No customer for subscription', noCustomerError)
